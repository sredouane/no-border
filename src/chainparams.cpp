...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000000"); // Block 1186833
		...
		*/
        ...
        // ENDBORDER BIP44 cointype in mainnet is '10467'
        nExtCoinType = 10467;
        ...
        chainTxData = ChainTxData{
            ...
            1636825063, // * UNIX timestamp of last known number of transactions
