...
QList<RavenUnits::Unit> RavenUnits::availableUnits()
{
    ...
    unitlist.append(ENB);
    unitlist.append(mENB);
    unitlist.append(uENB);
    return unitlist;
}
...
QString RavenUnits::name(int unit)
{
    switch(unit)
    {
    case ENB: return QString("ENB");
    case mENB: return QString("mENB");
    case uENB: return QString::fromUtf8("μENB");
...
QString RavenUnits::description(int unit)
{
    switch(unit)
    {
    case ENB: return QString("Ravens");
    case mENB: return QString("Milli-Ravens (1 / 1" THIN_SP_UTF8 "000)");
    case uENB: return QString("Micro-Ravens (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
...
qint64 RavenUnits::factor(int unit)
{
    switch(unit)
    {
    case ENB:  return 100000000;
    case mENB: return 100000;
    case uENB: return 100;
...
{
    return format(ENB, amount / factorAsset(MAX_ASSET_UNITS - unit), plussign, separators, unit) + QString(" ") + customName;
}
