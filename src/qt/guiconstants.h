...
#define QAPP_ORG_NAME "End-Border"
#define QAPP_ORG_DOMAIN "End-Border.org"
#define QAPP_APP_NAME_DEFAULT "enb-Qt"
#define QAPP_APP_NAME_TESTNET "End-Border-Qt-testnet"
