...
#ifndef ENDBORDER_ASSET_PROTOCOL_H
#define ENDBORDER_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVEN_ASSET ENBQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET ENBO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET ENBR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVEN_ASSET ENBT
...
#endif //ENDBORDER_ASSET_PROTOCOL_H
